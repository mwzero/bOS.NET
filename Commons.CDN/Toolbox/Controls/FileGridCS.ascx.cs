...
namespace bOS.Commons.UI.Controls
{
    public partial class FileGridCS : System.Web.UI.UserControl
    {
        #region Properties
        ...
        protected void gvFiles_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (item.IsFolder)
                {
                    ...
                    lbFolderItem.Text = string.Format(@"<img src=""{0}"" alt="""" />&nbsp;{1}", Page.ResolveClientUrl("~/Design/images/folder.png"), item.Name);
                }
                else
                {
